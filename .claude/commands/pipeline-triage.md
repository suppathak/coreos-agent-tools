...
4. At **GATE**, stop and wait for explicit approval before any Jira create/update or Jenkins job trigger. Suggest **@jira-similarity-search** next, then **@pipeline-handoff**.
5. For Jira drafting after triage + similarity, use **`go/skills/pipeline-jira/SKILL.md`** or **@pipeline-handoff**.
